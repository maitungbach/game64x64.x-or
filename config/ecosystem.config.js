  ...
  apps: [
    {
      ...
      env: {
        ...
        AUTH_COOKIE_SECURE: getEnv("AUTH_COOKIE_SECURE", "false"),
        ...
        AUTH_SEED_TEST_USERS: getEnv("AUTH_SEED_TEST_USERS", "true"),
        AUTH_ALLOW_CONCURRENT_SEED_USERS: getEnv("AUTH_ALLOW_CONCURRENT_SEED_USERS", "true"),
      },
